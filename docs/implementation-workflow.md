...
This process is uniform across every roadmap phase, from Phase 0 through Phase 11.
...
- **"Phase" means a roadmap phase.** Phase sequencing and Definition of Done refer to the phases defined in [roadmap.md](./roadmap.md) (Phase 0 through Phase 11), together with its Cross-cutting Capabilities.
